...
c     ------------------------------
      ...
      ! Box full x to z (1)
      call MPI_TYPE_VECTOR(NZP,NXPP,NX/2+1,
     &     MPI_DOUBLE_COMPLEX,TYPE1,ierror) 
      ...
      ! Box full x to z (2)
      call MPI_TYPE_VECTOR(NZP,NXPP,NXP+1,
     &     MPI_DOUBLE_COMPLEX,TYPE1,ierror) 
      call MPI_TYPE_COMMIT(TYPE1,ierror)                                              
      bl(1:2)=(/1, 1/)
...
c$$$
     ...
     *    V(0,0,J), 1, NX+2, TMP(0,0,J), 1, NX/2+1)
      ...
      !write(110+RANK) TMP(0:NX/2,0:NZP-1,40)
      VV=0.
     ...
     &        VV(0,0,J),1,XY2ZY_2,MPI_COMM_Z,IERROR)
      ...
      !write(120+RANK) VV(0:NXP-1,0:NZ-1,40)
      
      !stop 

      ! FFT in Z
      DO J=JMIN,JMAX
         CALL FFTWND_F77(FFTW_Z_TO_F_PLAN,NXPP,
...
C$$$      !write(140+RANK,'(2E25.15)') VV(0:NXP-1,0:NZ-1,1)
      ...
      DO J=JMIN,JMAX
         ...
         DO K=NKZ+1,NZ-NKZ-1
            ...
            END DO
         END DO
         CALL FFTWND_F77(FFTW_Z_TO_P_PLAN,NXPP,
     *        VV(0,0,J), NXP+1, 1, VV(0,0,J), NXP+1, 1)
      END DO
